# STORM SYSTEM OPTIMIZER - Automated Production Build & Release Script v0.2.1
$ErrorActionPreference = "Stop"

Write-Host "============================================================" -ForegroundColor Cyan
Write-Host " STORM SYSTEM OPTIMIZER v0.2.1 - PRODUCTION BUILD PIPELINE " -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Cyan
...
$setupV021 = Join-Path $filesDir "StormSystemOptimizer_Setup_v0.2.1.exe"
...
Write-Host "[4/6] Publishing Installer v0.2.1..." -ForegroundColor Yellow
...
Copy-Item $publishedInstaller $setupV021 -Force
...
if ($cert) {
    ...
    Set-AuthenticodeSignature -FilePath $setupV021 -Certificate $cert -HashAlgorithm SHA256 | Out-Null
...
Unblock-File -Path $setupV021 -ErrorAction SilentlyContinue

Write-Host "============================================================" -ForegroundColor Green
Write-Host " RELEASE v0.2.1 SUCCESSFULLY BUILT AND PACKAGED! " -ForegroundColor Green
Write-Host "============================================================" -ForegroundColor Green
Write-Host " 1. Portable EXE: $assemblingDir\StormSystemOptimizer.exe" -ForegroundColor Cyan
Write-Host " 2. Installer:    $setupV021" -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Green
