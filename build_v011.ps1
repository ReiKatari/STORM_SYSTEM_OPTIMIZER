# Build and Package Script for STORM SYSTEM OPTIMIZER v0.1.1 with Smart App Control / SmartScreen Trust
...
$outputInstaller = Join-Path $filesDir "StormSystemOptimizer_Setup_v0.1.1.exe"

Write-Host "=== 1. Publishing Standalone Native Single-File Executable v0.1.1 ===" -ForegroundColor Cyan
...
Write-Host "=== 3. Publishing Standalone Installer v0.1.1 ===" -ForegroundColor Cyan
