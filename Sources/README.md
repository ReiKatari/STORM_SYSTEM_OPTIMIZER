...
РЎРєСЂРёРїС‚ `build.ps1` РїСЂРѕРёР·РІРѕРґРёС‚:
  ...
  - РЎР±РѕСЂРєСѓ РёРЅСЃС‚Р°Р»Р»СЏС‚РѕСЂР° `StormInstaller.exe` Рё РµРіРѕ СѓРїР°РєРѕРІРєСѓ РІ `STORM_SYSTEM_OPTIMIZER_1.0.6_Setup.exe`.
