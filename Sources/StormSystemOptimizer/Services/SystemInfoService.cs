...
namespace StormSystemOptimizer.Services
{
    ...
    public class SystemInfoService
    {
        ...
        public string ExportSpecsToPlainText(List<HardwareDetailCategory> specs)
        {
            ...
            sb.AppendLine("================================================================================");
            sb.AppendLine("         Сформировано через STORM Engine 2.1.3 • 100% Safe Optimization         ");
            sb.AppendLine("==================================================================================");
            sb.AppendLine("             Конец отчета • STORM SYSTEM OPTIMIZER 2.1.3                        ");
            sb.AppendLine("==================================================================================");
            return sb.ToString();
        }
        ...
        public async Task<string> ExportHtmlReportAsync()
        {
            ...
            sb.AppendLine("<h1>⚡ STORM SYSTEM OPTIMIZER 2.1.3 — Диагностический отчет</h1>");
            sb.AppendLine($"<p style='color:#64748B;'>Сформировано: {DateTime.Now:dd.MM.yyyy HH:mm:ss} • STORM Engine 2.1.3</p>");
            return sb.ToString();
        }
