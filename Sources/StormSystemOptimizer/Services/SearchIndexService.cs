...
namespace StormSystemOptimizer.Services
{
    ...
    public class SearchIndexService
    {
        ...
        private void InitializeIndex()
        {
            ...
            AddItem("Расширения и плагины браузеров", "Централизованный аудит всех расширений Chrome, Edge, Яндекс Браузера, Firefox, Opera, Brave и удаление шпионских модулей", "Браузеры", "BrowserExtensions", "GeoBrowser", "расширения плагины браузер хром эдж яндекс brave opera firefox addons extensions");
            AddItem("Аудит задач планировщика и WMI", "Сканирование скрытых задач Task Scheduler, автозапуска при простое и WMI-потребителей событий", "Мониторинг", "TaskSchedulerAudit", "GeoTimer", "планировщик задач wmi задачи task scheduler автозапуск скрытые майнеры триггеры");
