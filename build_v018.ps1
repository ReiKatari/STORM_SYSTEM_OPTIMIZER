# STORM SYSTEM OPTIMIZER - Automated Production Build & Release Script v0.1.8
$ErrorActionPreference = "Stop"

Write-Host "============================================================" -ForegroundColor Cyan
Write-Host " STORM SYSTEM OPTIMIZER v0.1.8 - PRODUCTION BUILD PIPELINE " -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Cyan
...
$setupV018 = Join-Path $filesDir "StormSystemOptimizer_Setup_v0.1.8.exe"
...
Write-Host "[4/6] Publishing Installer v0.1.8..." -ForegroundColor Yellow
...
Copy-Item $publishedInstaller $setupV018 -Force
...
if ($cert) {
    ...
    Set-AuthenticodeSignature -FilePath $setupV018 -Certificate $cert -HashAlgorithm SHA256 | Out-Null
...
Unblock-File -Path $setupV018 -ErrorAction SilentlyContinue

Write-Host "============================================================" -ForegroundColor Green
Write-Host " RELEASE v0.1.8 SUCCESSFULLY BUILT AND PACKAGED! " -ForegroundColor Green
Write-Host "============================================================" -ForegroundColor Green
Write-Host " 1. Portable EXE: $assemblingDir\StormSystemOptimizer.exe" -ForegroundColor Cyan
Write-Host " 2. Installer:    $setupV018" -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Green
