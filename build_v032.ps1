# STORM SYSTEM OPTIMIZER - Automated Production Build & Release Script v0.3.2
$ErrorActionPreference = "Stop"

Write-Host "============================================================" -ForegroundColor Cyan
Write-Host " STORM SYSTEM OPTIMIZER v0.3.2 - PRODUCTION BUILD PIPELINE " -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Cyan
...
$setupV032 = Join-Path $filesDir "StormSystemOptimizer_Setup_v0.3.2.exe"
...
Write-Host "[4/6] Publishing Installer v0.3.2..." -ForegroundColor Yellow
...
Copy-Item $publishedInstaller $setupV032 -Force
...
if ($cert) {
    ...
    Set-AuthenticodeSignature -FilePath $setupV032 -Certificate $cert -HashAlgorithm SHA256 | Out-Null
...
Unblock-File -Path $setupV032 -ErrorAction SilentlyContinue

Write-Host "============================================================" -ForegroundColor Green
Write-Host " RELEASE v0.3.2 SUCCESSFULLY BUILT AND PACKAGED! " -ForegroundColor Green
Write-Host "============================================================" -ForegroundColor Green
Write-Host " 1. Portable EXE: $assemblingDir\StormSystemOptimizer.exe" -ForegroundColor Cyan
Write-Host " 2. Installer:    $setupV032" -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Green
