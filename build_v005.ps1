# Build and Package Script for STORM SYSTEM OPTIMIZER v0.0.5
...
$outputInstaller = Join-Path $filesDir "StormSystemOptimizer_Setup_v0.0.5.exe"

Write-Host "=== 1. Publishing Standalone Native Single-File Executable v0.0.5 ===" -ForegroundColor Cyan
...
Write-Host "=== 3. Publishing Standalone Installer v0.0.5 ===" -ForegroundColor Cyan
