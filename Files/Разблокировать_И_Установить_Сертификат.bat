...
echo ============================================================
echo   STORM SYSTEM OPTIMIZER v1.0.5 - СНЯТИЕ ВСЕХ БЛОКИРОВОК
...
:: ============================================================
echo.
echo [5/5] Запуск STORM SYSTEM OPTIMIZER v1.0.5...
echo.
echo ============================================================
...
if exist "%SCRIPT_DIR%Files\STORM_SYSTEM_OPTIMIZER_1.0.5_Setup.exe" (
...
) else if exist "%SCRIPT_DIR%STORM_SYSTEM_OPTIMIZER_1.0.5_Setup.exe" (
    start "" "%SCRIPT_DIR%STORM_SYSTEM_OPTIMIZER_1.0.5_Setup.exe"
)
