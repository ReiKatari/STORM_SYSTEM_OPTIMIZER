# STORM SYSTEM OPTIMIZER - Automated Production Build & Release Script v0.1.9
$ErrorActionPreference = "Stop"

Write-Host "============================================================" -ForegroundColor Cyan
Write-Host " STORM SYSTEM OPTIMIZER v0.1.9 - PRODUCTION BUILD PIPELINE " -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Cyan
...
$setupV019 = Join-Path $filesDir "StormSystemOptimizer_Setup_v0.1.9.exe"
...
Write-Host "[4/6] Publishing Installer v0.1.9..." -ForegroundColor Yellow
...
Copy-Item $publishedInstaller $setupV019 -Force
...
if ($cert) {
    ...
    Set-AuthenticodeSignature -FilePath $setupV019 -Certificate $cert -HashAlgorithm SHA256 | Out-Null
...
Unblock-File -Path $setupV019 -ErrorAction SilentlyContinue

Write-Host "============================================================" -ForegroundColor Green
Write-Host " RELEASE v0.1.9 SUCCESSFULLY BUILT AND PACKAGED! " -ForegroundColor Green
Write-Host "============================================================" -ForegroundColor Green
Write-Host " 1. Portable EXE: $assemblingDir\StormSystemOptimizer.exe" -ForegroundColor Cyan
Write-Host " 2. Installer:    $setupV019" -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Green
