# STORM SYSTEM OPTIMIZER - Automated Production Build & Release Script v0.1.7
$ErrorActionPreference = "Stop"

Write-Host "============================================================" -ForegroundColor Cyan
Write-Host " STORM SYSTEM OPTIMIZER v0.1.7 - PRODUCTION BUILD PIPELINE " -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Cyan
...
$setupV017 = Join-Path $filesDir "StormSystemOptimizer_Setup_v0.1.7.exe"
...
Write-Host "[4/6] Publishing Installer v0.1.7..." -ForegroundColor Yellow
...
Copy-Item $publishedInstaller $setupV017 -Force
...
if ($cert) {
    ...
    Set-AuthenticodeSignature -FilePath $setupV017 -Certificate $cert -HashAlgorithm SHA256 | Out-Null
...
Unblock-File -Path $setupV017 -ErrorAction SilentlyContinue

Write-Host "============================================================" -ForegroundColor Green
Write-Host " RELEASE v0.1.7 SUCCESSFULLY BUILT AND PACKAGED! " -ForegroundColor Green
Write-Host "============================================================" -ForegroundColor Green
Write-Host " 1. Portable EXE: $assemblingDir\StormSystemOptimizer.exe" -ForegroundColor Cyan
Write-Host " 2. Installer:    $setupV017" -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Green
